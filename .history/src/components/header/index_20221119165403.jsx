...
export default function Header() {
  ...
  useEffect(() => {
    ...
    PubSub.subscribe("changeInputAndClear", () => {
      setInputValue("")
    })
      ...
      <div className={style.headers}>
        ...
        <span className={style.left} >Small Shop</span>,
          <Tabs
            ...
            onChange={onChange}>
            <TabPane className={style.tabItem} tab="首页" key="/"></TabPane>
            <TabPane className={style.tabItem} tab="全部商品" key="/goods"></TabPane>
            <TabPane className={style.tabItem} tab="关于微商城" key="/about"></TabPane>
          </Tabs>
          <Search
