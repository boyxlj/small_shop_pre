...
export default [
  { path: '/', element: <Home /> },
  { path: '/goods', element: <Suspense fallback={<h1></h1>}><Goods /></Suspense>},
...
//   { path: 'goods', element: <Authorization><Suspense fallback={<h1></h1>}><Goods /></Suspense></Authorization> },
//   { path: 'car', element: <Authorization><Suspense fallback={<h1></h1>}><Car /></Suspense></Authorization> },
//   { path: 'order', element: <Authorization><Suspense fallback={<h1></h1>}><Order /></Suspense></Authorization> },
//   { path: 'details', element: <Authorization><Suspense fallback={<h1></h1>}><Details /></Suspense></Authorization> },
//   { path: 'collect', element: <Authorization><Suspense fallback={<h1></h1>}><Collect /></Suspense></Authorization> },
// ] },
